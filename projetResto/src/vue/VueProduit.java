...
public class VueProduit extends JPanel {
	...
	public VueProduit() {
		...
		/*
		 * cacher les colonne id user et id cat_produit du tableau
		 */
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Type_prod", "Code", "Prix"}));
		comboBox.setBounds(448, 36, 57, 19);
		panelListe.add(comboBox);
		
		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Asc", "Desc"}));
		comboBox_1.setBounds(389, 35, 50, 19);
		panelListe.add(comboBox_1);
